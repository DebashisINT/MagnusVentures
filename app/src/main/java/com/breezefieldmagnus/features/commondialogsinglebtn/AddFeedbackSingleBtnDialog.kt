package com.breezefieldmagnus.features.commondialogsinglebtn
...
import com.breezefieldmagnus.app.domain.ShopVisitCompetetorModelEntity
import com.breezefieldmagnus.app.domain.VisitRemarksEntity
...
import com.breezefieldmagnus.features.addshop.presentation.ProspectListDialog
import com.breezefieldmagnus.features.dashboard.presentation.DashboardActivity
import com.breezefieldmagnus.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefieldmagnus.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefieldmagnus/files", "recorded_audio${System.currentTimeMillis()}.mp3")
