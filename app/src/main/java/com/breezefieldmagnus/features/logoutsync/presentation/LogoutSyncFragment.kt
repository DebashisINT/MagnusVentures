package com.breezefieldmagnus.features.logoutsync.presentation
...
import com.breezefieldmagnus.CustomConstants
...
import com.breezefieldmagnus.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefieldmagnus.features.billing.api.AddBillingRepoProvider
import com.breezefieldmagnus.features.billing.model.AddBillingInputParamsModel
...
import com.breezefieldmagnus.features.dashboard.presentation.ReasonDialog
...
import com.breezefieldmagnus.features.document.model.AddEditDocumentInputParams
import com.breezefieldmagnus.features.document.model.DocumentAttachmentModel
...
import com.breezefieldmagnus.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefieldmagnus.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefieldmagnus.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefieldmagnus.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefieldmagnus.features.orderhistory.model.*
...
import com.breezefieldmagnus.features.quotation.model.AddQuotInputModel
import com.breezefieldmagnus.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefieldmagnus.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefieldmagnus.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefieldmagnus.features.stockAddCurrentStock.ShopAddCurrentStockList
...
import com.breezefieldmagnus.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefieldmagnus.features.timesheet.model.AddTimeSheetInputModel
import com.breezefieldmagnus.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefieldmagnus.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefieldmagnus.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefieldmagnus.mappackage.SendBrod
import com.breezefieldmagnus.widgets.AppCustomTextView
import com.breezefieldmagnus.MonitorService
import com.breezefieldmagnus.MySingleton
import com.breezefieldmagnus.app.AlarmReceiver
...
import com.breezefieldmagnus.features.addshop.presentation.ShopExtraContactReq
...
import com.breezefieldmagnus.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefieldmagnus.features.login.model.GetConcurrentUserResponse
...
import com.breezefieldmagnus.features.orderITC.SyncDeleteOpptL
import com.breezefieldmagnus.features.orderITC.SyncEditOppt
import com.breezefieldmagnus.features.orderITC.SyncOppt
import com.breezefieldmagnus.features.orderITC.SyncOpptProductL
import com.breezefieldmagnus.features.orderITC.SyncOrd
import com.breezefieldmagnus.features.orderITC.SyncOrdProductL
import com.breezefieldmagnus.features.performance.model.Gps_status_list
import com.breezefieldmagnus.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefieldmagnus.features.returnsOrder.ReturnProductList
import com.breezefieldmagnus.features.returnsOrder.ReturnRequest
import com.breezefieldmagnus.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefieldmagnus.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefieldmagnus/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmagnuslogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmagnuslogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefieldmagnuslogsample/log.zip").path);
