...
import com.breezefieldmagnus.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefieldmagnus.app.utils.FTStorageUtils
import com.breezefieldmagnus.app.utils.NotificationUtils
...
import com.breezefieldmagnus.features.addshop.model.AssignedToShopListResponseModel
import com.breezefieldmagnus.features.addshop.model.QuestionSubmit
import com.breezefieldmagnus.features.addshop.model.UpdateAddrReq
import com.breezefieldmagnus.features.addshop.model.UpdateAddressShop
...
import com.breezefieldmagnus.features.addshop.presentation.*
...
import com.breezefieldmagnus.features.location.model.ShopDurationRequestData
...
import com.breezefieldmagnus.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefieldmagnus.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefieldmagnus.features.nearbyshops.model.StageListResponseModel
...
import com.breezefieldmagnus.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefieldmagnus.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefieldmagnusApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
